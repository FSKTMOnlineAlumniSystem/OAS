...
loadEventSection(myEvent, yourUpcomingEventSection, "You have not invited to any event yet.");
// build html nodes based on notMyEvent
loadEventSection(notMyEvent, upcomingEventSection, "No other upcoming event available");