...
const yourUpcomingEventSection = document.getElementById(
...
export const loadEventSection = (eventArr, parentNode) => {
  eventArr.forEach((event) => {
    const eventDetails = dummyResponse.Event.filter(
    ...
    cardDiv.innerHTML = getCardStructure(
      event.eventId,
      imageId,
      title,
      dateTime
    ...
    cardDiv
      .querySelector("#" + event.eventId + "-card")
